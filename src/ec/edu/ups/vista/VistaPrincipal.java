...
import ec.edu.ups.vista.cliente.ListarClientes;
...
public class VistaPrincipal extends javax.swing.JFrame {
    ...
    private DeleteCliente deleteCliente1;
    ...
    public void cambiarIdioma() {
        ...
        itmUpdateFactura.setText(mensajes.getString("vista.item.update"));
        itmDeleteFactura.setText(mensajes.getString("vista.item.delete"));
        itmListarFactura.setText(mensajes.getString("vista.item.listar"));
    ...
    private void itmDeleteClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_itmDeleteClienteActionPerformed
        if (deleteCliente == null || deleteCliente.isVisible() == false) {
            deleteCliente = new DeleteCliente(controladorCliente, mensajes);
    ...
    private void itmListarClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_itmListarClienteActionPerformed
        ...
        if (listarClientes == null || listarClientes.isVisible() == false) {
            listarClientes = new ListarClientes(controladorCliente, mensajes);
    ...
    private void itmCreateFacturaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_itmCreateFacturaActionPerformed
        ...
        if (crearFactura == null || crearFactura.isVisible() == false) {
            crearFactura = new CrearFactura(controladorFactura, controladorCliente, mensajes);
    ...
    private void itmReadFacturaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_itmReadFacturaActionPerformed
        ...
        if (readFactura == null || readFactura.isVisible() == false) {
            readFactura = new ReadFactura(controladorFactura, mensajes);
